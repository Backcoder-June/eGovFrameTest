...
import egovframework.example.sample.service.serviceInterface.EgovMemberService;
...
public class EgovMemberServiceImpl extends EgovAbstractServiceImpl implements EgovMemberService {
	...
	private MemberMapper memberMapper;  //회원정보 관련 데이터베이스 접근 클래스
	...
	public MemberVO loginMember(MemberVO memberVO) throws Exception {
        ...
        egovLogger.debug("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
        egovLogger.debug("PASSWD - ENC : [" + hashedPass + "]");
        egovLogger.debug("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
        
        MemberVO loginVO = memberMapper.checkMember(memberVO);
